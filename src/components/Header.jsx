                    ...
                    <div className='text-center'>
                        <div className='container px-4 mx-auto'>
                            <div className='max-w-4xl mx-auto text-center'>
                                ...
                                <input type='text' className='block mx-auto w-4/5 my-8 outline-none py-1 sm:py-3 px-3 sm:px-5 capitalize rounded-md bg-gray-200 border-[1px] border-black' placeholder='Search Your Property...' />
